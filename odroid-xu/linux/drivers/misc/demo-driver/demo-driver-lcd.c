...
const uint32_t sc1602bs_rs_gpio = EXYNOS5_GPX1(6);	/* CON10.17 */
const uint32_t sc1602bs_rw_gpio = EXYNOS5_GPX2(5);	/* CON10.21 */
const uint32_t sc1602bs_es_gpio = EXYNOS5_GPX2(7);	/* CON10.22 */
const uint32_t sc1602bs_db_gpio[] = {
#if !defined(SC1602BS_DATA_BIT4)
#error not supported.
#endif /* SC1602BS_DATA_BIT4 */
	EXYNOS5_GPX2(2),	/* CON10.23 */
	EXYNOS5_GPX2(1),	/* CON10.24 */
	EXYNOS5_GPX1(7),	/* CON10.25 */
	EXYNOS5_GPX3(1),	/* CON10.27 */
};
